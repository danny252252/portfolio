  ...
  return (
    <div className="resume">
      <div className="letter">
        <h1>Cover Letter</h1>
        <p>
          Dear Sir or Madam,<br /><br /> My name is Daniel Beck. I'm from Hungary. I can
          <br />
          absolutely tell about myself is that I am a hard-
          <br />
          worker person. I've started my developer journey for 5-6
